...
;; :a2 :ioninan
(defn blue-ks1 [metro scale]
  ;; How to pass a metronome here?
  (let [[mode root-note] scale
        {:keys [octave pitch-class]} (note-info root-note)]
    (play-seq 0 ks1
              (cycle (map sort (progression blues-chords pitch-class octave mode)))
